...
class SMTP {
    ...
    */   
    ...
    public function __construct($smtp_username, $smtp_password, $smtp_host, $smtp_from, $smtp_port = 25, $smtp_charset = "Windows-1251") {
    ...
    */
    function send($mailTo, $subject, $message, $headers) {
        ...
        $contentMail .= 'Subject:'.$subject;//'Subject: =?' . $this->smtp_charset . '?B?'  . base64_encode($subject) . "=?=\r\n";
        $contentMail .= $headers;
        $contentMail .= $message . "\r\n";
